...
# -*- coding: utf-8 -*-
#
# pybroker documentation build configuration file, created by
...
_path_to_init = os.path.abspath(
    os.path.join(_docs_path, '..', 'pybroker', '__init__.py')
)
...
man_pages = [(master_doc, 'pybroker', 'PyBroker Documentation', [author], 1)]
