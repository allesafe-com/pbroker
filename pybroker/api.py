...
class Broker:
    ...
    :param list judges:
        ...
        Or :class:`~pybroker.judge.Judge` objects
    :param list providers:
        (optional) Urls of pages where to find proxies.
        Or :class:`~pybroker.providers.Provider` objects
    ...
    async def grab(self, *, countries=None, limit=0):
        ...
        :ref:`Example of usage <pybroker-examples-grab>`.
        """
    ...
    async def find(
        ...
        **kwargs,
        ...
        :ref:`Example of usage <pybroker-examples-find>`.
    ...
    def serve(self, host='127.0.0.1', port=8888, limit=100, **kwargs):
        ...
        :ref:`Example of usage <pybroker-examples-server>`.
